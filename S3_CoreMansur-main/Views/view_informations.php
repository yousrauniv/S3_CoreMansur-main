    ...
    <section class="page-content">
      ...
      <section class="grid">
        ...
        <article>
          ...
          <p>Date de naissance : <?= $_SESSION['user']['DateNaissance'] ?></p>
          <p>Email : <?= $_SESSION['user']['Email'] ?></p>
          <p>Numéro de téléphone : <?= $_SESSION['user']['Telephone'] ?></p>
        ...
        <article>
          ...
          if (isset($_SESSION['indication'])) {
            ...
            <h3>Changer votre mot de passe</h3> <br>
            <form action="?controller=informations&action=change_password" method="POST">
              <p>Mot de passe actuel</p>
              <input type="text" name="mdpActuel"><br>
              <p>Nouveau mot de passe</p>
              <input type="text" name="mdpNew"><br>
              <p>Confirmer le nouveau mot de passe actuel</p>
              <input type="text" name="mdpNewBis">
              <br>
              <input type="submit">
            </form>
        </article>
