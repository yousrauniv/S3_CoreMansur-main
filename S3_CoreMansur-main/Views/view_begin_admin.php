...
<head>
  ...
  <script type="text/javascript" src="./Content/js/admin.js" async></script>
  <title></title>
</head>
...
<body>
  ...
  <header class="page-header">
    <nav>
      ...
      <ul class="admin-menu">
        ...
        <li>
          <a href="?controller=admin&action=redirection&page=shopadmin">
            <svg>
        ...
        <li>
          <a href="?controller=admin&action=redirection&page=collectionadmin">
            <svg>
              <use xlink:href="#collection"></use>
            </svg>
        ...
        <li>
          <a href="?controller=galerie_admin">
            <svg>
              <use xlink:href="#collection"></use>
            </svg>
            <span>Page Galerie</span>
          </a>
        </li>
          <li>
          <a href="?controller=aboutus_admin">
            <svg>
              <use xlink:href="#collection"></use>
            </svg>
  ...
  <section class="page-content">
    <section class="search-and-user">
      ...
      <div class="admin-profile" style="justify-content: flex-end;">
        <span class="greeting"><?= $_SESSION['user']['Prenom']; ?></span>
